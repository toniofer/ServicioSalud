/*
       ...
       Generated on: 11/22/2010 6:33:1.51
...
namespace GeneXus.Programs {
   public class reorg : GXReorganization
   {
      ...
      public void ReorganizeConsulta( )
      {
         String cmdBuffer ;
         /* Indices for table Consulta */
         cmdBuffer=" ALTER TABLE [Consulta] DROP COLUMN [CantPacConf] "
         ;
      ...
      private void TablesCount( )
      {
         if ( ! IsResumeMode( ) )
         {
            ...
            ConsultaCount = P00012_AConsultaCount[0] ;
            pr_default.close(0);
            PrintRecordCount ( "Consulta" ,  ConsultaCount );
         }
      }
      ...
      private bool PreviousCheck( )
      {
         ...
         if ( ! ColumnExist("Consulta",sSchemaVar,"CantPacConf") )
         {
            SetCheckError ( GXResourceManager.GetMessage("GXM_column_not_exist", new   object[]  {"CantPacConf", "Consulta"}) );
            return false;
         }
         return true ;
      }
      ...
      {
         ReorgExecute.RegisterBlockForSubmit( 1 ,  "ReorganizeConsulta" , new Object[]{ });
      }
      ...
      {
         GXReorganization.SetMsg( 1 ,  GXResourceManager.GetMessage("GXM_fileupdate", new   object[]  {"Consulta", ""}) );
      }
      ...
      {
         scmdbuf = "" ;
         P00012_AConsultaCount = new int[1] ;
         sSchemaVar = "" ;
         nsSchemaVar = false ;
      ...
      protected int[] P00012_AConsultaCount ;
   ...
   public class reorg__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          def= new CursorDef[] {
              new CursorDef("P00012", "SELECT COUNT(*) FROM [Consulta] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmP00012,100,0,true,false )
