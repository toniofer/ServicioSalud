...
using System.IO;
public class bldalistarmedicos : GxBaseBuilder
{
   string cs_path = "." ;
   public bldalistarmedicos( ) : base()
   {
   }
   ...
   {
      bldalistarmedicos x = new bldalistarmedicos() ;
      x.SetMainSourceFile( "alistarmedicos.cs");
