...
using System.IO;
public class bldcategoryconsultarelationwc : GxBaseBuilder
{
   string cs_path = "." ;
   public bldcategoryconsultarelationwc( ) : base()
   {
   }
   ...
   {
      bldcategoryconsultarelationwc x = new bldcategoryconsultarelationwc() ;
      x.SetMainSourceFile( "categoryconsultarelationwc.cs");
