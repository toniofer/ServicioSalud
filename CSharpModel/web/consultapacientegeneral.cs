/*
               File: ConsultaPacienteGeneral
        Description: Consulta Paciente General
             Author: GeneXus C# Generator version 10_1_3-34981
       Generated on: 11/24/2010 5:13:4.91
...
namespace GeneXus.Programs {
   public class consultapacientegeneral : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public consultapacientegeneral( )
      {
      ...
      public consultapacientegeneral( IGxContext context )
      {
      ...
      public override void webExecute( )
      {
         ...
         if ( ! isAjaxCallMode( ) )
         {
            ...
            if ( ( GxWebError == 0 ) && ! isAjaxCallMode( ) )
            {
               ...
               A9EspecialidadId = H000F3_A9EspecialidadId[0] ;
               ...
               A11EspecialidadMaxPacientes = H000F4_A11EspecialidadMaxPacientes[0] ;
               ...
               A61TurnoNombre = H000F5_A61TurnoNombre[0] ;
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( "Consulta Paciente General") ;
      ...
      protected void RenderHtmlCloseForm0F2( )
      {
         ...
         {
            context.AddJavascriptSource("consultapacientegeneral.js", "?513513");
         }
      ...
      protected void WB0F0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "consultapacientegeneral.aspx");
            }
      ...
      protected void wb_table1_2_0F2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttBtnupdate_Internalname, "Modifica", "Modifica", "", StyleString, ClassString, 1, 1, "rounded", 5, bttBtnupdate_Jsonclick, sPrefix+"E\\'DOUPDATE\\'.", TempTags, "", "", "HLP_ConsultaPacienteGeneral.htm");
            TempTags = "  onfocus=\"gx.evt.onfocus(this, 64,'" + sPrefix + "',false,'',0)\"" ;
            ClassString = "ActionButtons" ;
            StyleString = "" ;
            GxWebStd.gx_button_ctrl( context, context.GetButtonType( ), bttBtndelete_Internalname, "Eliminar", "Eliminar", "", StyleString, ClassString, 1, 1, "rounded", 5, bttBtndelete_Jsonclick, sPrefix+"E\\'DODELETE\\'.", TempTags, "", "", "HLP_ConsultaPacienteGeneral.htm");
            /* Single line edit */
            ClassString = "Attribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtTurnoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A60TurnoId), 2, 0, ",", "")), "", 2, "chr", 1, "row", 2, edtTurnoId_Visible, 0, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(A60TurnoId), "Z9"), "", 0, edtTurnoId_Jsonclick, "", 0, 1, 1, true, "right", "HLP_ConsultaPacienteGeneral.htm");
         }
         wbLoad = true ;
      }
      ...
      protected void START0F2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("Description", "Consulta Paciente General", 0) ;
            context.wjLoc = "" ;
      ...
      protected void RF0F2( )
      {
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( (pr_default.getStatus(4) != 101) )
            {
               ...
               n63ConsultaNro = H000F6_n63ConsultaNro[0] ;
               /* Execute user event: E120F2 */
               E120F2 ();
      ...
      protected void STRUP0F0( )
      {
         ...
         A41PacienteCI = H000F7_A41PacienteCI[0] ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A41PacienteCI", A41PacienteCI);
         A35PacienteNombre = H000F7_A35PacienteNombre[0] ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A35PacienteNombre", A35PacienteNombre);
         A36PacienteApellido = H000F7_A36PacienteApellido[0] ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A36PacienteApellido", A36PacienteApellido);
         pr_default.close(5);
         /* Using cursor H000F8 */
         pr_default.execute(6, new Object[] {A12MedicoId});
         A9EspecialidadId = H000F8_A9EspecialidadId[0] ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A9EspecialidadId", StringUtil.LTrim( StringUtil.Str( (decimal)(A9EspecialidadId), 6, 0)));
         A13MedicoNombre = H000F8_A13MedicoNombre[0] ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A13MedicoNombre", A13MedicoNombre);
         A14MedicoApellido = H000F8_A14MedicoApellido[0] ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A14MedicoApellido", A14MedicoApellido);
         pr_default.close(6);
         /* Using cursor H000F9 */
         pr_default.execute(7, new Object[] {A9EspecialidadId});
         A11EspecialidadMaxPacientes = H000F9_A11EspecialidadMaxPacientes[0] ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A11EspecialidadMaxPacientes", StringUtil.LTrim( StringUtil.Str( (decimal)(A11EspecialidadMaxPacientes), 3, 0)));
         pr_default.close(7);
         /* Using cursor H000F10 */
         pr_default.execute(8, new Object[] {A60TurnoId});
         A61TurnoNombre = H000F10_A61TurnoNombre[0] ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A61TurnoNombre", A61TurnoNombre);
         pr_default.close(8);
      ...
      {
         /* 'DoUpdate' Routine */
         context.wjLoc = formatLink("consultapaciente.aspx") + "?" + UrlEncode(StringUtil.RTrim("UPD")) + "," + UrlEncode(DateTimeUtil.FormatDateParm(A43ConsultaFecha)) + "," + UrlEncode("" +A34PacienteId) + "," + UrlEncode("" +A12MedicoId) + "," + UrlEncode("" +A60TurnoId) ;
      }

      protected void E140F2( )
      {
         /* 'DoDelete' Routine */
         context.wjLoc = formatLink("consultapaciente.aspx") + "?" + UrlEncode(StringUtil.RTrim("DLT")) + "," + UrlEncode(DateTimeUtil.FormatDateParm(A43ConsultaFecha)) + "," + UrlEncode("" +A34PacienteId) + "," + UrlEncode("" +A12MedicoId) + "," + UrlEncode("" +A60TurnoId) ;
      }
      ...
      protected void wb_table1_2_0F2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockconsultafecha_Internalname, 1, 1, 0, "Consulta Fecha", "", "", "", 0, lblTextblockconsultafecha_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ...
            GxWebStd.gx_single_line_edit( context, edtConsultaFecha_Internalname, context.localUtil.Format(A43ConsultaFecha, "99/99/99"), "", 8, "chr", 1, "row", 8, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( A43ConsultaFecha, "99/99/99"), "", 0, edtConsultaFecha_Jsonclick, "", 0, 1, 1, true, "right", "HLP_ConsultaPacienteGeneral.htm");
            if ( ( 0 == 1 ) && ( 1 == 1 ) || ( 0 == 1 ) )
            {
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockpacienteid_Internalname, 1, 1, 0, "Paciente Id", "", "", "", 0, lblTextblockpacienteid_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtPacienteId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A34PacienteId), 6, 0, ",", "")), "", 6, "chr", 1, "row", 6, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(A34PacienteId), "ZZZZZ9"), "", 0, edtPacienteId_Jsonclick, "", 0, 1, 1, true, "right", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockpacientenombre_Internalname, 1, 1, 0, "Paciente Nombre", "", "", "", 0, lblTextblockpacientenombre_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtPacienteNombre_Internalname, StringUtil.RTrim( A35PacienteNombre), "", 20, "chr", 1, "row", 20, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A35PacienteNombre, "XXXXXXXXXXXXXXXXXXXX")), "", 0, edtPacienteNombre_Jsonclick, "", 0, 1, 1, true, "left", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockpacienteci_Internalname, 1, 1, 0, "Paciente CI", "", "", "", 0, lblTextblockpacienteci_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtPacienteCI_Internalname, StringUtil.RTrim( A41PacienteCI), "", 8, "chr", 1, "row", 8, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A41PacienteCI, "XXXXXXXX")), "", 0, edtPacienteCI_Jsonclick, "", 0, 1, 1, true, "left", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockmedicoid_Internalname, 1, 1, 0, "Medico Id", "", "", "", 0, lblTextblockmedicoid_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtMedicoId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A12MedicoId), 6, 0, ",", "")), "", 6, "chr", 1, "row", 6, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(A12MedicoId), "ZZZZZ9"), "", 0, edtMedicoId_Jsonclick, "", 0, 1, 1, true, "right", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockmedicoapellido_Internalname, 1, 1, 0, "Medico Apellido", "", "", "", 0, lblTextblockmedicoapellido_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtMedicoApellido_Internalname, StringUtil.RTrim( A14MedicoApellido), "", 20, "chr", 1, "row", 20, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A14MedicoApellido, "XXXXXXXXXXXXXXXXXXXX")), "", 0, edtMedicoApellido_Jsonclick, "", 0, 1, 1, true, "left", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockmediconombre_Internalname, 1, 1, 0, "Medico Nombre", "", "", "", 0, lblTextblockmediconombre_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtMedicoNombre_Internalname, StringUtil.RTrim( A13MedicoNombre), "", 20, "chr", 1, "row", 20, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A13MedicoNombre, "XXXXXXXXXXXXXXXXXXXX")), "", 0, edtMedicoNombre_Jsonclick, "", 0, 1, 1, true, "left", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockespecialidadmaxpacientes_Internalname, 1, 1, 0, "Especialidad Max Pacientes", "", "", "", 0, lblTextblockespecialidadmaxpacientes_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtEspecialidadMaxPacientes_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A11EspecialidadMaxPacientes), 3, 0, ",", "")), "", 3, "chr", 1, "row", 3, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(A11EspecialidadMaxPacientes), "ZZ9"), "", 0, edtEspecialidadMaxPacientes_Jsonclick, "", 0, 1, 1, true, "right", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockturnonombre_Internalname, 1, 1, 0, "Turno Nombre", "", "", "", 0, lblTextblockturnonombre_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtTurnoNombre_Internalname, StringUtil.RTrim( A61TurnoNombre), "", 20, "chr", 1, "row", 20, 1, 0, 0, 0, 0, "", "", StyleString, ClassString, "", StringUtil.RTrim( context.localUtil.Format( A61TurnoNombre, "XXXXXXXXXXXXXXXXXXXX")), "", 0, edtTurnoNombre_Jsonclick, "", 0, 1, 1, true, "left", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockconsultanro_Internalname, 1, 1, 0, "Nro", "", "", "", 0, lblTextblockconsultanro_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Single line edit */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtConsultaNro_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A63ConsultaNro), 2, 0, ",", "")), "", 2, "chr", 1, "row", 2, 1, 0, 0, 0, 0, edtConsultaNro_Link, "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(A63ConsultaNro), "Z9"), "", 0, edtConsultaNro_Jsonclick, "", 0, 1, 1, true, "right", "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            context.WriteHtmlText( "<td>") ;
            ...
            ClassString = "TextBlock" ;
            StyleString = "" ;
            GxWebStd.gx_label_ctrl( context, lblTextblockconfirmado_Internalname, 1, 1, 0, "Confirmado", "", "", "", 0, lblTextblockconfirmado_Jsonclick, "", StyleString, ClassString, "HLP_ConsultaPacienteGeneral.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "<td>") ;
            /* Check box */
            ClassString = "ReadonlyAttribute" ;
            StyleString = "" ;
            GxWebStd.gx_checkbox_ctrl( context, chkConfirmado_Internalname, StringUtil.BoolToStr( A75Confirmado), "", 1, 0, "true", "", StyleString, ClassString, "");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "</tbody>") ;
            /* End of table */
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "consultapacientegeneral");
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?513630");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      {
         context.AddJavascriptSource("consultapacientegeneral.js", "?513630");
      ...
      protected void initialize_properties( )
      {
         ...
         lblTextblockconfirmado_Internalname = sPrefix+"TEXTBLOCKCONFIRMADO" ;
         chkConfirmado_Internalname = sPrefix+"CONFIRMADO" ;
      ...
      public override void initialize( )
      {
         ...
         AV17Pgmname = "" ;
         scmdbuf = "" ;
         H000F2_A41PacienteCI = new String[] {""} ;
         H000F2_A35PacienteNombre = new String[] {""} ;
         H000F2_A36PacienteApellido = new String[] {""} ;
         A41PacienteCI = "" ;
         A35PacienteNombre = "" ;
         A36PacienteApellido = "" ;
         H000F3_A9EspecialidadId = new int[1] ;
         H000F3_A13MedicoNombre = new String[] {""} ;
         H000F3_A14MedicoApellido = new String[] {""} ;
         A13MedicoNombre = "" ;
         A14MedicoApellido = "" ;
         H000F4_A11EspecialidadMaxPacientes = new short[1] ;
         H000F5_A61TurnoNombre = new String[] {""} ;
         A61TurnoNombre = "" ;
         sDynURL = "" ;
         FormProcess = "" ;
         GXt_char1 = "" ;
         ...
         EvtRowId = "" ;
         sEvtType = "" ;
         H000F6_A9EspecialidadId = new int[1] ;
         H000F6_A43ConsultaFecha = new DateTime[] {DateTime.MinValue} ;
         H000F6_A34PacienteId = new int[1] ;
         H000F6_A12MedicoId = new int[1] ;
         H000F6_A60TurnoId = new short[1] ;
         H000F6_A75Confirmado = new bool[] {false} ;
         H000F6_A63ConsultaNro = new short[1] ;
         H000F6_n63ConsultaNro = new bool[] {false} ;
         H000F6_A61TurnoNombre = new String[] {""} ;
         H000F6_A11EspecialidadMaxPacientes = new short[1] ;
         H000F6_A13MedicoNombre = new String[] {""} ;
         H000F6_A14MedicoApellido = new String[] {""} ;
         H000F6_A41PacienteCI = new String[] {""} ;
         H000F6_A35PacienteNombre = new String[] {""} ;
         H000F6_A36PacienteApellido = new String[] {""} ;
         H000F7_A41PacienteCI = new String[] {""} ;
         H000F7_A35PacienteNombre = new String[] {""} ;
         H000F7_A36PacienteApellido = new String[] {""} ;
         H000F8_A9EspecialidadId = new int[1] ;
         H000F8_A13MedicoNombre = new String[] {""} ;
         H000F8_A14MedicoApellido = new String[] {""} ;
         H000F9_A11EspecialidadMaxPacientes = new short[1] ;
         H000F10_A61TurnoNombre = new String[] {""} ;
         AV11TrnContext = new SdtTransactionContext(context);
         ...
         GXt_char5 = "" ;
         GXt_char6 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.consultapacientegeneral__default(),
            new Object[][] {
                new Object[] {
               H000F2_A41PacienteCI, H000F2_A35PacienteNombre, H000F2_A36PacienteApellido
               }
               , new Object[] {
               H000F3_A9EspecialidadId, H000F3_A13MedicoNombre, H000F3_A14MedicoApellido
               }
               , new Object[] {
               H000F4_A11EspecialidadMaxPacientes
               }
               , new Object[] {
               H000F5_A61TurnoNombre
               }
               , new Object[] {
               H000F6_A9EspecialidadId, H000F6_A43ConsultaFecha, H000F6_A34PacienteId, H000F6_A12MedicoId, H000F6_A60TurnoId, H000F6_A75Confirmado, H000F6_A63ConsultaNro, H000F6_n63ConsultaNro, H000F6_A61TurnoNombre, H000F6_A11EspecialidadMaxPacientes,
               H000F6_A13MedicoNombre, H000F6_A14MedicoApellido, H000F6_A41PacienteCI, H000F6_A35PacienteNombre, H000F6_A36PacienteApellido
               }
               , new Object[] {
               H000F7_A41PacienteCI, H000F7_A35PacienteNombre, H000F7_A36PacienteApellido
               }
               , new Object[] {
               H000F8_A9EspecialidadId, H000F8_A13MedicoNombre, H000F8_A14MedicoApellido
               }
               , new Object[] {
               H000F9_A11EspecialidadMaxPacientes
               }
               , new Object[] {
               H000F10_A61TurnoNombre
               }
            }
         );
         AV17Pgmname = "ConsultaPacienteGeneral" ;
      ...
      private String[] H000F2_A41PacienteCI ;
      private String[] H000F2_A35PacienteNombre ;
      private String[] H000F2_A36PacienteApellido ;
      private int[] H000F3_A9EspecialidadId ;
      private String[] H000F3_A13MedicoNombre ;
      private String[] H000F3_A14MedicoApellido ;
      private short[] H000F4_A11EspecialidadMaxPacientes ;
      private String[] H000F5_A61TurnoNombre ;
      private int[] H000F6_A9EspecialidadId ;
      private DateTime[] H000F6_A43ConsultaFecha ;
      private int[] H000F6_A34PacienteId ;
      private int[] H000F6_A12MedicoId ;
      private short[] H000F6_A60TurnoId ;
      private bool[] H000F6_A75Confirmado ;
      private short[] H000F6_A63ConsultaNro ;
      private bool[] H000F6_n63ConsultaNro ;
      private String[] H000F6_A61TurnoNombre ;
      private short[] H000F6_A11EspecialidadMaxPacientes ;
      private String[] H000F6_A13MedicoNombre ;
      private String[] H000F6_A14MedicoApellido ;
      private String[] H000F6_A41PacienteCI ;
      private String[] H000F6_A35PacienteNombre ;
      private String[] H000F6_A36PacienteApellido ;
      private String[] H000F7_A41PacienteCI ;
      private String[] H000F7_A35PacienteNombre ;
      private String[] H000F7_A36PacienteApellido ;
      private int[] H000F8_A9EspecialidadId ;
      private String[] H000F8_A13MedicoNombre ;
      private String[] H000F8_A14MedicoApellido ;
      private short[] H000F9_A11EspecialidadMaxPacientes ;
      private String[] H000F10_A61TurnoNombre ;
   ...
   public class consultapacientegeneral__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          Object[] prmH000F7 ;
          prmH000F7 = new Object[] {
          new Object[] {"@PacienteId",SqlDbType.Int,6,0}
          } ;
          Object[] prmH000F8 ;
          prmH000F8 = new Object[] {
          new Object[] {"@MedicoId",SqlDbType.Int,6,0}
          } ;
          Object[] prmH000F9 ;
          prmH000F9 = new Object[] {
          new Object[] {"@EspecialidadId",SqlDbType.Int,6,0}
          } ;
          Object[] prmH000F10 ;
          prmH000F10 = new Object[] {
          new Object[] {"@TurnoId",SqlDbType.SmallInt,2,0}
          } ;
          def= new CursorDef[] {
              new CursorDef("H000F2", "SELECT [PacienteCI], [PacienteNombre], [PacienteApellido] FROM [Paciente] WITH (NOLOCK) WHERE [PacienteId] = @PacienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F2,1,0,true,true )
             ,new CursorDef("H000F3", "SELECT [EspecialidadId], [MedicoNombre], [MedicoApellido] FROM [Medico] WITH (NOLOCK) WHERE [MedicoId] = @MedicoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F3,1,0,true,true )
             ,new CursorDef("H000F4", "SELECT [EspecialidadMaxPacientes] FROM [Especialidad] WITH (NOLOCK) WHERE [EspecialidadId] = @EspecialidadId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F4,1,0,true,true )
             ,new CursorDef("H000F5", "SELECT [TurnoNombre] FROM [Turno] WITH (NOLOCK) WHERE [TurnoId] = @TurnoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F5,1,0,true,true )
             ,new CursorDef("H000F6", "SELECT T3.[EspecialidadId], T1.[ConsultaFecha], T1.[PacienteId], T1.[MedicoId], T1.[TurnoId], T1.[Confirmado], T1.[ConsultaNro], T5.[TurnoNombre], T4.[EspecialidadMaxPacientes], T3.[MedicoNombre], T3.[MedicoApellido], T2.[PacienteCI], T2.[PacienteNombre], T2.[PacienteApellido] FROM (((([ConsultaPaciente] T1 WITH (NOLOCK) INNER JOIN [Paciente] T2 WITH (NOLOCK) ON T2.[PacienteId] = T1.[PacienteId]) INNER JOIN [Medico] T3 WITH (NOLOCK) ON T3.[MedicoId] = T1.[MedicoId]) INNER JOIN [Especialidad] T4 WITH (NOLOCK) ON T4.[EspecialidadId] = T3.[EspecialidadId]) INNER JOIN [Turno] T5 WITH (NOLOCK) ON T5.[TurnoId] = T1.[TurnoId]) WHERE T1.[ConsultaFecha] = @ConsultaFecha and T1.[PacienteId] = @PacienteId and T1.[MedicoId] = @MedicoId and T1.[TurnoId] = @TurnoId ORDER BY T1.[ConsultaFecha], T1.[PacienteId], T1.[MedicoId], T1.[TurnoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F6,1,0,true,true )
             ,new CursorDef("H000F7", "SELECT [PacienteCI], [PacienteNombre], [PacienteApellido] FROM [Paciente] WITH (NOLOCK) WHERE [PacienteId] = @PacienteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F7,1,0,true,true )
             ,new CursorDef("H000F8", "SELECT [EspecialidadId], [MedicoNombre], [MedicoApellido] FROM [Medico] WITH (NOLOCK) WHERE [MedicoId] = @MedicoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F8,1,0,true,true )
             ,new CursorDef("H000F9", "SELECT [EspecialidadMaxPacientes] FROM [Especialidad] WITH (NOLOCK) WHERE [EspecialidadId] = @EspecialidadId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F9,1,0,true,true )
             ,new CursorDef("H000F10", "SELECT [TurnoNombre] FROM [Turno] WITH (NOLOCK) WHERE [TurnoId] = @TurnoId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000F10,1,0,true,true )
          };
       }
    }
