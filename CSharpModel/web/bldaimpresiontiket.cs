...
using System.IO;
public class bldaimpresiontiket : GxBaseBuilder
{
   string cs_path = "." ;
   public bldaimpresiontiket( ) : base()
   {
   }
   ...
   {
      bldaimpresiontiket x = new bldaimpresiontiket() ;
      x.SetMainSourceFile( "aimpresiontiket.cs");
