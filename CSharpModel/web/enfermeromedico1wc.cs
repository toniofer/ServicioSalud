/*
               File: EnfermeroMedico1WC
        Description: Enfermero Medico1 WC
             Author: GeneXus C# Generator version 10_1_3-34981
       Generated on: 11/22/2010 4:0:14.93
...
namespace GeneXus.Programs {
   public class enfermeromedico1wc : GXWebComponent, System.Web.SessionState.IRequiresSessionState
   {
      public enfermeromedico1wc( )
      {
      ...
      public enfermeromedico1wc( IGxContext context )
      {
      ...
      public void execute( int aP0_EnfermeroSuplenteId )
      {
         this.AV7EnfermeroSuplenteId = aP0_EnfermeroSuplenteId;
         executePrivate();
      }
         ...
         if ( StringUtil.Len( (String)(sPrefix)) == 0 )
         {
            if ( nGotPars == 0 )
            {
               ...
               else if ( StringUtil.StrCmp(gxfirstwebparm, "dyncomponent") == 0 )
               {
                  ...
                  AV7EnfermeroSuplenteId = (int)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  componentprepare(new Object[] {(String)sCompPrefix,(String)sSFPrefix,(int)AV7EnfermeroSuplenteId});
                  componentstart();
               ...
               {
                  /* GeneXus formulas. */
                  AV16Pgmname = "EnfermeroMedico1WC" ;
                  context.Gx_err = 0 ;
                  ...
                  AV7EnfermeroSuplenteId = (int)(NumberUtil.Val( GetNextPar( ), ".")) ;
                  context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7EnfermeroSuplenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7EnfermeroSuplenteId), 6, 0)));
                  edtavDelete_Tooltiptext = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
                  AV13Delete = GetNextPar( ) ;
                  context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Bitmap", context.convertURL( AV13Delete));
                  ...
                  gxgrGrid_refresh( Grid_PageSize12, AV7EnfermeroSuplenteId, AV13Delete, AV12Update, sPrefix) ;
                  return  ;
               }
               else
               {
      ...
      protected void RenderHtmlOpenForm( )
      {
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            context.WriteHtmlText( "Enfermero Medico1 WC") ;
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            if ( nGXWrapped != 1 )
            {
               context.WriteHtmlTextNl( "<form id=\"MAINFORM\" onsubmit=\"try{return gx.csv.validForm()}catch(e){return true;}\" name=\"MAINFORM\" method=\"post\" action=\""+formatLink("enfermeromedico1wc.aspx") + "?" + UrlEncode("" +AV7EnfermeroSuplenteId)+"\" class=\""+"Form"+"\">") ;
      ...
      protected void RenderHtmlCloseForm0B2( )
      {
         ...
         GxWebStd.gx_hidden_field( context, sPrefix+"wcpOAV7EnfermeroSuplenteId", StringUtil.LTrim( StringUtil.NToC( (decimal)(wcpOAV7EnfermeroSuplenteId), 6, 0, ",", "")));
         GxWebStd.gx_hidden_field( context, sPrefix+"_ENFERMEROSUPLENTEID", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7EnfermeroSuplenteId), 6, 0, ",", "")));
         ...
         {
            context.AddJavascriptSource("enfermeromedico1wc.js", "?401512");
         }
      ...
      protected void WB0B0( )
      {
         ...
         if ( ! wbLoad )
         {
            ...
            if ( StringUtil.Len( sPrefix) != 0 )
            {
               GxWebStd.gx_hidden_field( context, sPrefix+"_CMPPGM", "enfermeromedico1wc.aspx");
            }
      ...
      protected void wb_table1_2_0B2e( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_single_line_edit( context, edtEnfermeroSuplenteId_Internalname, StringUtil.LTrim( StringUtil.NToC( (decimal)(A51EnfermeroSuplenteId), 6, 0, ",", "")), "", 6, "chr", 1, "row", 6, edtEnfermeroSuplenteId_Visible, 0, 0, 0, 0, "", "", StyleString, ClassString, "", context.localUtil.Format( (decimal)(A51EnfermeroSuplenteId), "ZZZZZ9"), "", 0, edtEnfermeroSuplenteId_Jsonclick, "", 0, 1, 1, true, "right", "HLP_EnfermeroMedico1WC.htm");
         }
         wbLoad = true ;
      }
      ...
      protected void START0B2( )
      {
         ...
         if ( StringUtil.Len( sPrefix) == 0 )
         {
            ...
            Form.Meta.addItem("Description", "Enfermero Medico1 WC", 0) ;
            context.wjLoc = "" ;
                     ...
                     if ( StringUtil.StrCmp(sEvtType, "E") == 0 )
                     {
                        ...
                        else
                        {
                           ...
                           if ( ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "START") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 9), "GRID.LOAD") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 5), "ENTER") == 0 ) || ( StringUtil.StrCmp(StringUtil.Left( sEvt, 6), "CANCEL") == 0 ) )
                           {
                              ...
                              edtEnfermeroTitularId_Internalname = sPrefix+"ENFERMEROTITULARID_"+sGXsfl_12_idx ;
                              edtEnfermeroTitularNombre_Internalname = sPrefix+"ENFERMEROTITULARNOMBRE_"+sGXsfl_12_idx ;
                              edtEnfermeroTitularApellido_Internalname = sPrefix+"ENFERMEROTITULARAPELLIDO_"+sGXsfl_12_idx ;
                              ...
                              context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A47EnfermeroTitularNombre", A47EnfermeroTitularNombre);
                              A48EnfermeroTitularApellido = cgiGet( edtEnfermeroTitularApellido_Internalname) ;
                              n48EnfermeroTitularApellido = false ;
                              context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A48EnfermeroTitularApellido", A48EnfermeroTitularApellido);
                              sEvtType = StringUtil.Right( sEvt, 1) ;
                              if ( StringUtil.StrCmp(sEvtType, ".") == 0 )
                              {
                                 sEvt = StringUtil.Left( sEvt, (short)(StringUtil.Len( sEvt)-1)) ;
      ...
      protected void RF0B2( )
      {
         ...
         if ( String.IsNullOrEmpty(StringUtil.RTrim( context.wjLoc)) && ( context.nUserReturn != 1 ) )
         {
            ...
            while ( ( (pr_default.getStatus(0) != 101) ) && ( ( ( subGrid_Rows == 0 ) || ( GRID_nCurrentRecord < GRID_nFirstRecordOnPage + subGrid_Recordsperpage( ) ) ) ) )
            {
               ...
               A48EnfermeroTitularApellido = H000B2_A48EnfermeroTitularApellido[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A48EnfermeroTitularApellido", A48EnfermeroTitularApellido);
               n48EnfermeroTitularApellido = H000B2_n48EnfermeroTitularApellido[0] ;
               A47EnfermeroTitularNombre = H000B2_A47EnfermeroTitularNombre[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A47EnfermeroTitularNombre", A47EnfermeroTitularNombre);
               n47EnfermeroTitularNombre = H000B2_n47EnfermeroTitularNombre[0] ;
               A46EnfermeroTitularId = H000B2_A46EnfermeroTitularId[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A46EnfermeroTitularId", StringUtil.LTrim( StringUtil.Str( (decimal)(A46EnfermeroTitularId), 6, 0)));
               A10EspecialidadDescripcion = H000B2_A10EspecialidadDescripcion[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A10EspecialidadDescripcion", A10EspecialidadDescripcion);
               A9EspecialidadId = H000B2_A9EspecialidadId[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A9EspecialidadId", StringUtil.LTrim( StringUtil.Str( (decimal)(A9EspecialidadId), 6, 0)));
               A18MedicoFechaIngreso = H000B2_A18MedicoFechaIngreso[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A18MedicoFechaIngreso", context.localUtil.Format(A18MedicoFechaIngreso, "99/99/99"));
               A17MedicoEstadoCivil = H000B2_A17MedicoEstadoCivil[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A17MedicoEstadoCivil", A17MedicoEstadoCivil);
               A16MedicoTelefono = H000B2_A16MedicoTelefono[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A16MedicoTelefono", A16MedicoTelefono);
               A15MedicoDomicilio = H000B2_A15MedicoDomicilio[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A15MedicoDomicilio", A15MedicoDomicilio);
               A14MedicoApellido = H000B2_A14MedicoApellido[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A14MedicoApellido", A14MedicoApellido);
               A13MedicoNombre = H000B2_A13MedicoNombre[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A13MedicoNombre", A13MedicoNombre);
               A12MedicoId = H000B2_A12MedicoId[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A12MedicoId", StringUtil.LTrim( StringUtil.Str( (decimal)(A12MedicoId), 6, 0)));
               A48EnfermeroTitularApellido = H000B2_A48EnfermeroTitularApellido[0] ;
               context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "A48EnfermeroTitularApellido", A48EnfermeroTitularApellido);
               n48EnfermeroTitularApellido = H000B2_n48EnfermeroTitularApellido[0] ;
      ...
      {
         /* Using cursor H000B3 */
         pr_default.execute(1, new Object[] {AV7EnfermeroSuplenteId});
      ...
      protected void STRUP0B0( )
      {
         ...
         if ( ! GetJustCreated( ) && ( StringUtil.StrCmp(context.GetRequestMethod( ), "POST") == 0 ) )
         {
            ...
            wcpOAV7EnfermeroSuplenteId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7EnfermeroSuplenteId"), ",", ".")) ;
      ...
      protected void E110B2( )
      {
         ...
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtavDelete_Internalname, "Tooltiptext", edtavDelete_Tooltiptext);
         edtEnfermeroSuplenteId_Visible = 0 ;
         context.httpAjaxContext.ajax_rsp_assign_prop(sPrefix, false, edtEnfermeroSuplenteId_Internalname, "Visible", StringUtil.LTrim( StringUtil.Str( (decimal)(edtEnfermeroSuplenteId_Visible), 5, 0)));
      ...
      protected void S112( )
      {
         ...
         AV11TrnContextAtt.gxTpr_Attributename = "EnfermeroSuplenteId" ;
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV11TrnContextAtt", (Object)(AV11TrnContextAtt));
         AV11TrnContextAtt.gxTpr_Attributevalue = StringUtil.Str( (decimal)(AV7EnfermeroSuplenteId), 6, 0) ;
         context.httpAjaxContext.ajax_rsp_assign_sdt_attri(sPrefix, false, "AV11TrnContextAtt", (Object)(AV11TrnContextAtt));
      ...
      protected void wb_table2_5_0B2( bool wbgen )
      {
         if ( wbgen )
         {
            ...
            StyleString = "" ;
            GxWebStd.gx_bitmap( context, imgInsert_Internalname, "", context.GetImagePath( "5649fbb8-8ce0-4810-a5ce-bd649ea83c3a", "", "GeneXusX"), "GeneXusX", 1, 1, "", "Agrega", 0, 0, 0, "", 0, "", 0, 0, "", "", 7, imgInsert_Jsonclick, "'"+sPrefix+"'"+",false,"+"'"+"e130b2_client"+"'", StyleString, ClassString, "", ""+TempTags, "", "", "HLP_EnfermeroMedico1WC.htm");
            context.WriteHtmlText( "</td>") ;
            context.WriteHtmlText( "</tr>") ;
            context.WriteHtmlText( "<tr>") ;
            ...
            if ( GridContainer.GetWrapped() == 1 )
            {
               ...
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"right"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Titular Id") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Titular Nombre") ;
               context.WriteHtmlTextNl( "</th>") ;
               context.WriteHtmlText( "<th align=\""+"left"+"\" "+" nowrap=\"nowrap\" "+" class=\""+subGrid_Linesclass+"\" "+" style=\""+((-1==0) ? "display:none;" : "")+""+"\" "+">") ;
               context.SendWebValue( "Titular Apellido") ;
               context.WriteHtmlTextNl( "</th>") ;
            ...
            else
            {
               ...
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.LTrim( StringUtil.NToC( (decimal)(A46EnfermeroTitularId), 6, 0, ".", "")));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A47EnfermeroTitularNombre));
               GridContainer.AddColumnProperties(GridColumn);
               GridColumn = GXWebColumn.GetNew(isAjaxCallMode( )) ;
               GridColumn.AddObjectProperty("Value", StringUtil.RTrim( A48EnfermeroTitularApellido));
               GridContainer.AddColumnProperties(GridColumn);
      ...
      public override void setparameters( Object[] obj )
      {
         createObjects();
         initialize();
         AV7EnfermeroSuplenteId = Convert.ToInt32(getParm(obj,0)) ;
         context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7EnfermeroSuplenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7EnfermeroSuplenteId), 6, 0)));
      }
      ...
      public override void componentbind( Object[] obj )
      {
         ...
         sCtrlAV7EnfermeroSuplenteId = (String)((String)getParm(obj,0)) ;
      }
      ...
      public override void componentprepare( Object[] obj )
      {
         ...
         AddComponentObject(sPrefix, "enfermeromedico1wc");
         ...
         {
            AV7EnfermeroSuplenteId = Convert.ToInt32(getParm(obj,2)) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7EnfermeroSuplenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7EnfermeroSuplenteId), 6, 0)));
         }
         wcpOAV7EnfermeroSuplenteId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"wcpOAV7EnfermeroSuplenteId"), ",", ".")) ;
         if ( ! GetJustCreated( ) && ( ( AV7EnfermeroSuplenteId != wcpOAV7EnfermeroSuplenteId ) ) )
         {
            setjustcreated();
         }
         wcpOAV7EnfermeroSuplenteId = AV7EnfermeroSuplenteId ;
      }

      protected void WCParametersGet( )
      {
         /* Read Component Parameters. */
         sCtrlAV7EnfermeroSuplenteId = cgiGet( sPrefix+"AV7EnfermeroSuplenteId_CTRL") ;
         if ( StringUtil.Len( sCtrlAV7EnfermeroSuplenteId) > 0 )
         {
            AV7EnfermeroSuplenteId = (int)(context.localUtil.CToN( cgiGet( sCtrlAV7EnfermeroSuplenteId), ",", ".")) ;
            context.httpAjaxContext.ajax_rsp_assign_attri(sPrefix, false, "AV7EnfermeroSuplenteId", StringUtil.LTrim( StringUtil.Str( (decimal)(AV7EnfermeroSuplenteId), 6, 0)));
         }
         else
         {
            AV7EnfermeroSuplenteId = (int)(context.localUtil.CToN( cgiGet( sPrefix+"AV7EnfermeroSuplenteId_PARM"), ",", ".")) ;
         }
      }
      ...
      {
         GxWebStd.gx_hidden_field( context, sPrefix+"AV7EnfermeroSuplenteId_PARM", StringUtil.LTrim( StringUtil.NToC( (decimal)(AV7EnfermeroSuplenteId), 6, 0, ",", "")));
         if ( StringUtil.Len( StringUtil.RTrim( sCtrlAV7EnfermeroSuplenteId)) > 0 )
         {
            GxWebStd.gx_hidden_field( context, sPrefix+"AV7EnfermeroSuplenteId_CTRL", StringUtil.RTrim( sCtrlAV7EnfermeroSuplenteId));
         }
      }
      ...
      protected void define_styles( )
      {
         ...
         {
            context.AddJavascriptSource(StringUtil.RTrim( Form.Jscriptsrc.Item(idxLst)), "?401654");
            idxLst = (int)(idxLst+1) ;
         }
      ...
      protected void include_jscripts( )
      {
         if ( nGXWrapped != 1 )
         {
            context.AddJavascriptSource("enfermeromedico1wc.js", "?401656");
         }
      ...
      protected void sendrow_122( )
      {
         ...
         if ( ( subGrid_Rows * 1 == 0 ) || ( nGXsfl_12_idx <= subGrid_Recordsperpage( ) * 1 ) )
         {
            ...
            ClassString = "Image" ;
            StyleString = "" ;
            GridRow.AddColumnProperties("bitmap", 2, isAjaxCallMode( ), new Object[] {(String)edtavDelete_Internalname,(String)"",(String)AV13Delete,(String)"GeneXusX",(short)-1,(short)0,(String)"",(String)edtavDelete_Tooltiptext,(short)0,(short)-1,(short)0,(String)"px",(short)0,(String)"",(short)0,(short)0,(String)"",(String)"",(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)"",(String)"",(String)"''",(String)""});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtEnfermeroTitularId_Internalname,StringUtil.LTrim( StringUtil.NToC( (decimal)(A46EnfermeroTitularId), 6, 0, ",", "")),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)6,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,context.localUtil.Format( (decimal)(A46EnfermeroTitularId), "ZZZZZ9"),(String)"",(short)0,(String)edtEnfermeroTitularId_Jsonclick,(String)"",(short)12,(short)1,(short)1,(bool)true,(String)"right"});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtEnfermeroTitularNombre_Internalname,StringUtil.RTrim( A47EnfermeroTitularNombre),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)20,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( A47EnfermeroTitularNombre, "XXXXXXXXXXXXXXXXXXXX")),(String)"",(short)0,(String)edtEnfermeroTitularNombre_Jsonclick,(String)"",(short)12,(short)1,(short)1,(bool)true,(String)"left"});
            /* Subfile cell */
            if ( GridContainer.GetWrapped() == 1 )
            {
               context.WriteHtmlText( "<td valign=\"middle\" align=\""+"left"+"\""+" style=\""+((-1==0) ? "display:none;" : "")+"\">") ;
            ...
            StyleString = "" ;
            ROClassString = ClassString ;
            GridRow.AddColumnProperties("edit", 1, isAjaxCallMode( ), new Object[] {(String)edtEnfermeroTitularApellido_Internalname,StringUtil.RTrim( A48EnfermeroTitularApellido),(String)"",(short)0,(String)"px",(short)17,(String)"",(short)20,(short)-1,(short)0,(short)0,(short)0,(short)0,(String)"",(String)"",(String)StyleString,(String)ClassString,(String)ROClassString,StringUtil.RTrim( context.localUtil.Format( A48EnfermeroTitularApellido, "XXXXXXXXXXXXXXXXXXXX")),(String)"",(short)0,(String)edtEnfermeroTitularApellido_Jsonclick,(String)"",(short)12,(short)1,(short)1,(bool)true,(String)"left"});
      ...
      protected void initialize_properties( )
      {
         ...
         edtEnfermeroSuplenteId_Internalname = sPrefix+"ENFERMEROSUPLENTEID" ;
         ...
         edtEnfermeroSuplenteId_Visible = 1 ;
         subGrid_Rows = 0 ;
         edtavUpdate_Tooltiptext = "Modifica" ;
         edtavDelete_Tooltiptext = "Eliminar" ;
      }
      ...
      public override void initialize( )
      {
         ...
         edtEnfermeroTitularId_Internalname = "" ;
         edtEnfermeroTitularNombre_Internalname = "" ;
         edtEnfermeroTitularApellido_Internalname = "" ;
         A13MedicoNombre = "" ;
         A14MedicoApellido = "" ;
         A15MedicoDomicilio = "" ;
         A16MedicoTelefono = "" ;
         ...
         scmdbuf = "" ;
         H000B2_A51EnfermeroSuplenteId = new int[1] ;
         H000B2_A48EnfermeroTitularApellido = new String[] {""} ;
         H000B2_n48EnfermeroTitularApellido = new bool[] {false} ;
         H000B2_A47EnfermeroTitularNombre = new String[] {""} ;
         H000B2_n47EnfermeroTitularNombre = new bool[] {false} ;
         H000B2_A46EnfermeroTitularId = new int[1] ;
         H000B2_A10EspecialidadDescripcion = new String[] {""} ;
         H000B2_A9EspecialidadId = new int[1] ;
         H000B2_A18MedicoFechaIngreso = new DateTime[] {DateTime.MinValue} ;
         H000B2_A17MedicoEstadoCivil = new String[] {""} ;
         H000B2_A16MedicoTelefono = new String[] {""} ;
         H000B2_A15MedicoDomicilio = new String[] {""} ;
         H000B2_A14MedicoApellido = new String[] {""} ;
         H000B2_A13MedicoNombre = new String[] {""} ;
         H000B2_A12MedicoId = new int[1] ;
         H000B3_AGRID_nRecordCount = new int[1] ;
         AV10TrnContext = new SdtTransactionContext(context);
         ...
         sCtrlAV7EnfermeroSuplenteId = "" ;
         GridRow = new GXWebRow();
         ROClassString = "" ;
         GXt_char15 = "" ;
         pr_default = new DataStoreProvider(context, new GeneXus.Programs.enfermeromedico1wc__default(),
            new Object[][] {
                new Object[] {
               H000B2_A51EnfermeroSuplenteId, H000B2_A48EnfermeroTitularApellido, H000B2_n48EnfermeroTitularApellido, H000B2_A47EnfermeroTitularNombre, H000B2_n47EnfermeroTitularNombre, H000B2_A46EnfermeroTitularId, H000B2_A10EspecialidadDescripcion, H000B2_A9EspecialidadId, H000B2_A18MedicoFechaIngreso, H000B2_A17MedicoEstadoCivil,
               H000B2_A16MedicoTelefono, H000B2_A15MedicoDomicilio, H000B2_A14MedicoApellido, H000B2_A13MedicoNombre, H000B2_A12MedicoId
               }
               , new Object[] {
      ...
      private int AV7EnfermeroSuplenteId ;
      private int wcpOAV7EnfermeroSuplenteId ;
      private int Grid_PageSize12 ;
      private int GRID_nFirstRecordOnPage ;
      private int A51EnfermeroSuplenteId ;
      private int edtEnfermeroSuplenteId_Visible ;
      ...
      private String sCtrlAV7EnfermeroSuplenteId ;
      ...
      private int[] H000B2_A51EnfermeroSuplenteId ;
      private String[] H000B2_A48EnfermeroTitularApellido ;
      private bool[] H000B2_n48EnfermeroTitularApellido ;
      private String[] H000B2_A47EnfermeroTitularNombre ;
      private bool[] H000B2_n47EnfermeroTitularNombre ;
      private int[] H000B2_A46EnfermeroTitularId ;
      private String[] H000B2_A10EspecialidadDescripcion ;
      private int[] H000B2_A9EspecialidadId ;
      private DateTime[] H000B2_A18MedicoFechaIngreso ;
      private String[] H000B2_A17MedicoEstadoCivil ;
      private String[] H000B2_A16MedicoTelefono ;
      private String[] H000B2_A15MedicoDomicilio ;
      private String[] H000B2_A14MedicoApellido ;
      private String[] H000B2_A13MedicoNombre ;
      private int[] H000B2_A12MedicoId ;
      private int[] H000B3_AGRID_nRecordCount ;
   ...
   public class enfermeromedico1wc__default : DataStoreHelperBase, IDataStoreHelper
   {
    ...
    private void cursorDefinitions( )
    {
       if ( def == null )
       {
          ...
          new Object[] {"@AV7EnfermeroSuplenteId",SqlDbType.Int,6,0}
          } ;
          Object[] prmH000B3 ;
          ...
          def= new CursorDef[] {
              new CursorDef("H000B2", "SELECT T1.[EnfermeroSuplenteId], T2.[EnfermeroApellido] AS EnfermeroTitularApellido, T2.[EnfermeroNombre] AS EnfermeroTitularNombre, T1.[EnfermeroTitularId] AS EnfermeroTitularId, T3.[EspecialidadDescripcion], T1.[EspecialidadId], T1.[MedicoFechaIngreso], T1.[MedicoEstadoCivil], T1.[MedicoTelefono], T1.[MedicoDomicilio], T1.[MedicoApellido], T1.[MedicoNombre], T1.[MedicoId] FROM (([Medico] T1 WITH (NOLOCK) INNER JOIN [Enfermero] T2 WITH (NOLOCK) ON T2.[EnfermeroId] = T1.[EnfermeroTitularId]) INNER JOIN [Especialidad] T3 WITH (NOLOCK) ON T3.[EspecialidadId] = T1.[EspecialidadId]) WHERE T1.[EnfermeroSuplenteId] = @AV7EnfermeroSuplenteId ORDER BY T1.[MedicoId] ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B2,11,0,true,false )
             ,new CursorDef("H000B3", "SELECT COUNT(*) FROM (([Medico] T1 WITH (NOLOCK) INNER JOIN [Enfermero] T3 WITH (NOLOCK) ON T3.[EnfermeroId] = T1.[EnfermeroTitularId]) INNER JOIN [Especialidad] T2 WITH (NOLOCK) ON T2.[EspecialidadId] = T1.[EspecialidadId]) WHERE T1.[EnfermeroSuplenteId] = @AV7EnfermeroSuplenteId ",false, GxErrorMask.GX_NOMASK | GxErrorMask.GX_MASKLOOPLOCK, false, this,prmH000B3,1,0,true,false )
          };
       }
    }
