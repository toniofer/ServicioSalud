...
using System.IO;
public class bldcategorygestionconsultarelationwc : GxBaseBuilder
{
   string cs_path = "." ;
   public bldcategorygestionconsultarelationwc( ) : base()
   {
   }
   ...
   {
      bldcategorygestionconsultarelationwc x = new bldcategorygestionconsultarelationwc() ;
      x.SetMainSourceFile( "categorygestionconsultarelationwc.cs");
