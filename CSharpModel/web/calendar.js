...
Calendar.dayMouseDown = function(ev) {
	...
	try
	{
		if (typeof(cal.params.inputField.onfocus) == 'function')
		{
			cal.params.inputField.onfocus();
		}
	}
	catch(e)
	{
		gx.dbg.logEx(e, 'calendar.js', 'Calendar.dayMouseDown');
	}
	cal.activeDiv = el;
	Calendar._C = cal;
...
Calendar.prototype.callHandler = function () {
	if (this.onSelected) {
		this.onSelected(this, this.date.print(this.dateFormat), this.params.inputField);
